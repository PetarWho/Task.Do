...
namespace TaskDo.Migrations
{
    ...
    [Migration("20231116131814_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TaskDo.Data.Entities.Subtask", b =>
                {
                    ...
                    b.Property<int>("RequiredNotesCount")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TaskDo.Data.Entities.Employee", b =>
                {
                    b.HasBaseType("TaskDo.Data.Entities.User");
            ...
            modelBuilder.Entity("TaskDo.Data.Entities.Manager", b =>
                {
                    b.HasBaseType("TaskDo.Data.Entities.User");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("TaskDo.Data.Entities.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("TaskDo.Data.Entities.Note", b =>
                {
                    b.HasOne("TaskDo.Data.Entities.Subtask", null)
                        .WithMany("Notes")
            ...
            modelBuilder.Entity("TaskDo.Data.Entities.Picture", b =>
                {
                    b.HasOne("TaskDo.Data.Entities.Subtask", "Subtask")
                        .WithMany("Images")
                        .HasForeignKey("SubtaskId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("TaskDo.Data.Entities.Subtask", b =>
                {
                    b.HasOne("TaskDo.Data.Entities.Employee", null)
                        .WithMany("Subtasks")
                        .HasForeignKey("EmployeeId");
